...
enum AmadeusConnect {
    ...
    private AmadeusConnect() {
        this.amadeus = Amadeus
                .builder("PkImdfD7J6aGcwvVSu4M4qiL8jZnBfaE", "xxxQzldfElQ3NpnV")
                .build();
    }
    ...
    public FlightOfferSearch[] flights(String origin, String destination, String departDate, String adults, String returnDate, String currency) throws ResponseException {
