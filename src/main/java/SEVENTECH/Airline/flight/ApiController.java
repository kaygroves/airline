...
public class ApiController {
    ...
    @CrossOrigin(origins= "https://localhost:3000")
    @GetMapping("/v2/shopping/flight-offers") //changing /flights to whatever
    public FlightOfferSearch[] flights(@RequestParam(required=true) String origin,
        ...
        return AmadeusConnect.INSTANCE.flights(origin, destination, departDate, adults, returnDate,currency);
    }
